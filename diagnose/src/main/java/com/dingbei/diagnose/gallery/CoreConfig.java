...
public class CoreConfig {
    ...
    private CoreConfig(Builder builder) {
        ...
        if ( takePhotoFolder == null ) {
            takePhotoFolder = new File(Environment.getExternalStorageDirectory(), "/DCIM/" + "dingbei/");
        }
        ...
        if ( editPhotoCacheFolder == null ) {
            editPhotoCacheFolder = new File(Environment.getExternalStorageDirectory() + "/dingbei/edittemp/");
        }
